...
crates/cg-clif/ is our MIR->Cranelift codegen crate using r-a types. This is where active development happens.
...
just test-clif -E 'test(std_jit_vec_pop_smoke)' --no-capture
