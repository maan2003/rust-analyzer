...
mod attr_impl {
    ...
    // Equivalent of rustc_data_structures::external_bitflags_debug!
...
// size_asserts removed: requires rustc_data_structures::static_assert_size
